...
**[Apple Foundation Model](https://arxiv.org/abs/2507.13575)**          
Core contributor to the agent and tool-use capabilities, enabling the model to effectively plan, reason, and execute complex multi-step tasks via tool calls.

**[Microsoft Phi-3](https://arxiv.org/abs/2404.14219) & [Phi-4](https://arxiv.org/abs/2503.01743)**          
Core contributor to the post-training stage for the Phi model family, focusing on maximizing general capabilities in small language models.
